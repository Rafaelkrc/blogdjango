...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='page',
            name='is_published',
            field=models.BooleanField(default=False, help_text='Este campo precisa estar selecionado para a página ser exibida!'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=False, help_text='Este campo precisa estar selecionado para o POST ser exibido!')),
